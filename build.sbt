...
lazy val guessCountryJS = project in file("./apps/guessCountry")
lazy val guessCountryJVM = project in file("./apps/guessCountry")
...
lazy val driverJS = driver.js.dependsOn(ticTacToeJS, memoryJS, guessCountryJS)
lazy val driverJVM = driver.jvm.dependsOn(ticTacToeJVM, memoryJVM, guessCountryJVM)

/// Aggregate project

lazy val webapp = (project in file("."))
  .aggregate(
    ticTacToeJS, ticTacToeJVM, memoryJS, memoryJVM, driverJS, driverJVM, guessCountryJS, guessCountryJVM
  ).settings(
    name := "webapp",
    scalaVersion := "3.3.1",
    scalacOptions ++= Seq("-deprecation"),
    ...
    copyTestReportsTask := {
      ...
      Seq(
        ...
        "TEST-driver.GuessCountryTest.xml"
